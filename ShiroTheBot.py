...
#dispatcher.add_handler(CommandHandler('lights', functions.change_lights))
...
dispatcher.add_handler(CommandHandler('animal_pic', functions.send_cute_pic,
									  pass_args=True))

#dispatcher.add_handler(CallbackQueryHandler(functions.button))
